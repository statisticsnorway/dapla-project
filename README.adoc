...
Refer to the link:dapla-localstack/README.md[localstack] for more information about how to spin up a local dapla runtime environment.
...
* link:dapla-localstack/README.md[localstack]
