...
put $exploration_lds '/ns/RepresentedVariable/RepresentedVariable_DUMMY' '{
 "lastUpdatedBy": "Test",
 "name": [
  {
   "languageCode": "nb",
...
put $exploration_lds '/ns/UnitType/UnitType_DUMMY' '{
    "id": "UnitType_DUMMY",
    "name": [
      {
        "languageCode": "en",
...
put $exploration_lds '/ns/DescribedValueDomain/DescribedValueDomain_DUMMY' '{
...
put $exploration_lds '/ns/SubjectField/SubjectField_DUMMY' '{
 "lastUpdatedBy": "Test",
